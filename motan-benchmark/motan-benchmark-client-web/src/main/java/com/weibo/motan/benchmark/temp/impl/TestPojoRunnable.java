...
package com.weibo.motan.benchmark.temp.impl;

import com.weibo.motan.benchmark.BenchmarkService;
import com.weibo.motan.benchmark.FullName;
import com.weibo.motan.benchmark.Person;
import com.weibo.motan.benchmark.temp.AbstractClientRunnable;
...
public class TestPojoRunnable extends AbstractClientRunnable {
    ...
    public TestPojoRunnable(BenchmarkService service, String size, CyclicBarrier barrier, CountDownLatch latch, long startTime, long endTime) {
